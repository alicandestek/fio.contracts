...
namespace fioio {
    ...
    eosio_names_table;
          ...
          EOSLIB_SERIALIZE( nftinfo, (chain_code)(contract_address)(token_id)(url)(hash)(metadata))
        };
    ...
    indexed_by<"byaddress"_n, const_mem_fun<nft, uint128_t, &nft::by_address>>
    >
    nfts_table;
